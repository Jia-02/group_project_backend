...
public class DeliveryTaskReq {
	...
	public DeliveryTaskReq() {
		super();
	}
	
	

	public DeliveryTaskReq(String orderNo, int deliveryId) {
		super();
	...
	public DeliveryTaskReq(String orderNo, int deliveryId, LocalDate date, BigDecimal distanceKm, String status,
