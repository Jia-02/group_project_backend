...
public class OrdersMealRes extends BasicRes {
	...
	public OrdersMealRes() {
		super();
		// TODO Auto-generated constructor stub
	}

	public OrdersMealRes(int code, String message) {
		super(code, message);
		// TODO Auto-generated constructor stub
	}

	public OrdersMealRes(int code, String message, int ordersId, String ordersType, LocalDate ordersDate,
			...
			List<OrdersMealVo> orderDetailsList) {
		super(code, message);
